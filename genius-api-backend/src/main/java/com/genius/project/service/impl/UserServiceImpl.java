...
//    private InterfaceInfoService interfaceInfoService;
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "genius";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            QueryWrapper<InterfaceInfo> queryWrapper1 = new QueryWrapper<>();
            List<InterfaceInfo> interfaceInfos = interfaceInfoMapper.selectList(queryWrapper1);
